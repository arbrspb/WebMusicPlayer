# reckordbox_parser.py 14-08-25 01-50
"""Анализ жанров из экспортированного файла Rekordbox (анализ жанровых настроек, статистики и вывода)."""
import os
...
def parse_reckordbox_xml(xml_path, output_path=None):
    """
    Парсит XML-файл библиотеки Rekordbox и сохраняет список треков в формате JSON.

    Args:
        xml_path (str): Путь к XML-файлу Rekordbox.
        output_path (str, optional): Путь для сохранения JSON-файла. Если не задан, используется папка OUTPUT_DIR.
